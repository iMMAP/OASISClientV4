...
Begin VB.Form frmIncidentsV2SitrepGenerator 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Incident Situational Reports"
   ClientHeight    =   5100
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   8745
   Icon            =   "frmIncidentsV2SitrepGenerator.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   5100
   ...
   Begin C1SizerLibCtl.C1Elastic C1Elastic 
      ...
      FloodStyle      =   1
      _GridInfo       =   $"frmIncidentsV2SitrepGenerator.frx":6852
      AccessibleName  =   ""
      ...
      Begin C1SizerLibCtl.C1Tab C1TTab1Tab 
         ...
         Begin C1SizerLibCtl.C1Elastic C1Elastic 
            ...
            FloodColor      =   6553600
            ForeColorDisabled=   -2147483631
            Picture         =   "frmIncidentsV2SitrepGenerator.frx":6927
            Caption         =   ""
            Align           =   0
            AutoSizeChildren=   8
            BorderWidth     =   0
            ...
            FrameShadow     =   -2147483632
            FloodStyle      =   1
            _GridInfo       =   $"frmIncidentsV2SitrepGenerator.frx":776E
            AccessibleName  =   ""
            AccessibleDescription=   ""
            AccessibleValue =   ""
            AccessibleRole  =   9
            ...
            Begin C1SizerLibCtl.C1Elastic C1Elastic 
               ...
               FrameShadow     =   -2147483632
               FloodStyle      =   1
               _GridInfo       =   $"frmIncidentsV2SitrepGenerator.frx":787A
               AccessibleName  =   ""
               AccessibleDescription=   ""
               AccessibleValue =   ""
               AccessibleRole  =   9
               Begin VB.ListBox lstTopics 
                  Height          =   2010
                  ItemData        =   "frmIncidentsV2SitrepGenerator.frx":78AE
                  Left            =   0
                  List            =   "frmIncidentsV2SitrepGenerator.frx":78B0
                  TabIndex        =   14
                  Top             =   0
                  Width           =   2130
               End
            ...
            Begin RichTextLib.RichTextBox RichTextBox 
               ...
               _Version        =   393217
               Enabled         =   0   'False
               TextRTF         =   $"frmIncidentsV2SitrepGenerator.frx":78B2
            End
   ...
   End
End
Attribute VB_Name = "frmIncidentsV2SitrepGenerator"
...
PopulateCombo_Err:
        MsgBox Err.Description & vbCrLf & _
               "in OASISClient.frmIncidentsV2SitrepGenerator.PopulateCombo " & _
               "at line " & Erl
        Resume Next
        '</EhFooter>
End Sub
...
102     mCN.ConnectionString = IIf(bSQLServerInUse, m_Cnn, "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" & g_sAppPath & "\data\db\DynamicData\IncidentsV2.mdb;Mode=ReadWrite|Share Deny None;Persist Security Info=False")
104     mCN.CursorLocation = g_sGlobalCursorLocation
106     mCN.Open
    
108     PopulateCombo ComEnteredBy, "dd_" & g_sIncidentsV2DDName & "_mastertable", "DetailEnteredBy"
110     ComEnteredBy.Text = sUserName
112     ComEnteredBy.Enabled = True
114     ComEnteredBy.Locked = False
    
116     PopulateCombo ComOfficeName, "dd_" & g_sIncidentsV2DDName & "_mastertable", "DetailResponsibleOffice"
...
130     PopulateList lstTopics, "dd_" & g_sIncidentsV2DDName & "_ddEventCategory"
132     lstTopics.AddItem "-- OVERALL --"
134     PopulateCombo ComSecRating, "dd_" & g_sIncidentsV2DDName & "_ddZoneRatings", "Risk"
...
Init_Err:
        MsgBox Err.Description & vbCrLf & _
               "in OASISClient.frmIncidentsV2SitrepGenerator.Init " & _
               "at line " & Erl
        Resume Next
        '</EhFooter>
End Sub
...
PopulateList_Err:
        MsgBox Err.Description & vbCrLf & _
               "in OASISClient.frmIncidentsV2SitrepGenerator.PopulateList " & _
               "at line " & Erl
        Resume Next
        '</EhFooter>
End Sub
...
cmdCancel_Click_Err:
        MsgBox Err.Description & vbCrLf & _
               "in OASISClient.frmIncidentsV2SitrepGenerator.cmdCancel_Click " & _
               "at line " & Erl
        Resume Next
        '</EhFooter>
End Sub
...
ShowWait_Err:
        MsgBox Err.Description & vbCrLf & _
               "in OASISClient.frmIncidentsV2SitrepGenerator.ShowWait " & _
               "at line " & Erl
        Resume Next
        '</EhFooter>
End Sub
...
cmdPreview_Click_Err:
        MsgBox Err.Description & vbCrLf & _
               "in OASISClient.frmIncidentsV2SitrepGenerator.cmdPreview_Click " & _
               "at line " & Erl
        Resume Next
        '</EhFooter>
End Sub
...
ComSecRating_Click_Err:
        MsgBox Err.Description & vbCrLf & _
               "in OASISClient.frmIncidentsV2SitrepGenerator.ComSecRating_Click " & _
               "at line " & Erl
        Resume Next
        '</EhFooter>
End Sub
...
ComSecRating_LostFocus_Err:
        MsgBox Err.Description & vbCrLf & _
               "in OASISClient.frmIncidentsV2SitrepGenerator.ComSecRating_LostFocus " & _
               "at line " & Erl
        Resume Next
        '</EhFooter>
End Sub
...
lblSitrepTopics_Click_Err:
        MsgBox Err.Description & vbCrLf & _
               "in OASISClient.frmIncidentsV2SitrepGenerator.lblSitrepTopics_Click " & _
               "at line " & Erl
        Resume Next
        '</EhFooter>
End Sub
...
lstTopics_Click_Err:
        MsgBox Err.Description & vbCrLf & _
               "in OASISClient.frmIncidentsV2SitrepGenerator.lstTopics_Click " & _
               "at line " & Erl
        Resume Next
        '</EhFooter>
End Sub
...
RichTextBox_LostFocus_Err:
        MsgBox Err.Description & vbCrLf & _
               "in OASISClient.frmIncidentsV2SitrepGenerator.RichTextBox_LostFocus " & _
               "at line " & Erl
        Resume Next
        '</EhFooter>
End Sub
...
SaveStrings_Err:
        MsgBox Err.Description & vbCrLf & _
               "in OASISClient.frmIncidentsV2SitrepGenerator.SaveStrings " & _
               "at line " & Erl
        Resume Next
        '</EhFooter>
End Sub
...
FetchStrings_Err:
        MsgBox Err.Description & vbCrLf & _
               "in OASISClient.frmIncidentsV2SitrepGenerator.FetchStrings " & _
               "at line " & Erl
        Resume Next
        '</EhFooter>
End Sub
